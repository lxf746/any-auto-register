...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    {
        "provider_type": "mailbox",
        "provider_key": "omnimail_api",
        "label": "OmniMail（自建域名）",
        "description": "连接自部署 OmniMail，通过官方 API 自动创建邮箱并读取验证码",
        "driver_type": "omnimail_api",
        "default_auth_mode": "password",
        "enabled": True,
        "category": "selfhost",
        "auth_modes": [{"value": "password", "label": "账号密码"}],
        "fields": [
            {
                "key": "omnimail_api_url",
                "label": "API 地址",
            ...
            },
            {
                ...
                "category": "connection",
                "hint": "需已在 OmniMail 中启用。",
            },
            {
                "key": "omnimail_username",
                "label": "登录邮箱",
                "placeholder": "automation@example.com",
                "category": "auth",
                "hint": "建议使用未启用 MFA、仅有创建邮箱权限的专用账号。",
            },
            {"key": "omnimail_password", "label": "登录密码", "secret": True, "category": "auth"},
        ],
    },
    {
        "provider_type": "mailbox",
